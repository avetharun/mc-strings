...
if __name__ == "__main__":
    ...
    inverted_ascii_map = {v: k for k, v in ascii_map.items()}
    htoi = {v: hex(v) for k, v in ascii_map.items()}
    print(ascii_map)
    for i in range(0,10):
        print("\n")
    print(inverted_ascii_map)
    for i in range(0,10):
        print("\n")
    print(htoi)
    inverted_htoi = {v: k for k, v in htoi.items()}
    for i in range(0,10):
        print("\n")
    print(inverted_htoi)
